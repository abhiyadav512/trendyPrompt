            ...
            <div className="max-w-md w-full p-8 ">
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    <button
                        ...
                        className={`w-full py-2 border rounded-lg border-slate-700 hover:bg-slate-800 hover:text-white transition duration-200 ${loginMutation.isLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
