  ...
  const handleSubmit = (e) => {
    ...
    if (modalMode === "create") {
      createPrompt(payload, {
        ...
        onError: (err) => {
          toast.error(
            err?.response?.data?.message || "Failed to create prompt.",
          );
        },
      });
      ...
      updatePromptMutation(
        { id: currentPrompt._id, formData: payload },
        {
          ...
          onError: (err) => {
            toast.error(
              err?.response?.data?.message || "Failed to update prompt.",
            );
          },
        },
      );
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {stats.map((stat, i) => (
            <div
              key={i}
              className="bg-white/10 dark:bg-black/30 border dark:border-white/20 rounded-xl p-6"
            >
