      ...
      <div className="relative w-full max-w-3xl mx-auto bg-white dark:bg-black rounded-lg shadow-xl flex flex-col max-h-[90vh] sm:max-h-[80vh]">
        ...
        >
          ...
          <section>
            ...
            <p className="mb-4">
              AI prompts are carefully crafted instructions that help you get
              better results from AI assistants. Here's how to use them
              effectively:
            </p>
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong>Replace placeholders:</strong> Replace text in
                [BRACKETS]
              </li>
              <li>
                <strong>Be specific:</strong> Detailed input improves output
              </li>
              <li>
                <strong>Iterate:</strong> Refine prompts as needed
              </li>
              <li>
                <strong>Context matters:</strong> Provide background if helpful
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="p-4 rounded-lg bg-gray-100 dark:bg-neutral-900">
              ...
              <p>
                "Help me write a story about a time-traveling detective who
                solves cold cases"
              </p>
            </div>
          </section>
